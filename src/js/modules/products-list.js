...
if (productsList) {
  ...
  const paginationCurrent = document.querySelector('.navigation-products-list__pagination-current');
  const paginationTotal = document.querySelector('.navigation-products-list__pagination-total');
  const paginationButtonPrev = document.querySelector('.navigation-products-list__button--prev');
  const paginationButtonNext = document.querySelector('.navigation-products-list__button--next');
  ...
  const displayProducts = (products) => {
    ...
    products.forEach((product) => {
      ...
      cardImage.srcset = `./img/catalog-data/${product.name.toLowerCase()}@2x.jpg`;
